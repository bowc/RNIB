...
jQuery(function() {
    ...
    jQuery('form[name=billingaddressaddform],#tlusermyform form,form[name=addressbookform],form[name=billingaddresseditform],form[name=deliveryaddressaddform]').validate({
        rules: {
            title   : {
                required: true
            },
